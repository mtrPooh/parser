...
class Vendor extends HttpProcessor
{
    ...
    private const API_URL1 = 'https://www.cbrstyle.com/v9/collection/anon/';
    private const API_URL2 = 'https://www.cbrstyle.com/v9/product/anon/';
    private const PRODUCT_URL = 'https://www.cbrstyle.com/product/-/';

    protected array $first = [ 'https://www.cbrstyle.com/' ];

    public function getProductsLinks( Data $data, string $url ): array
    {
        if ( $url === 'https://www.cbrstyle.com/' || str_contains( $url, '.html' ) === false ) {
            return [];
        }
